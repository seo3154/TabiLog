        ...
        <tbody>
          {filteredPosts.length > 0 ? (
            filteredPosts.map((post) => (
              <tr key={post.boardID}>
                <td><Link to={`/community/post/${post.boardID}`}>{post.boardID}</Link></td>
                <td><Link to={`/community/post/${post.boardID}`}>{post.mbti}</Link></td>
                <td className="title"><Link to={`/community/post/${post.boardID}`}>{post.title}</Link></td>
                <td><Link to={`/community/post/${post.boardID}`}>{post.userName}</Link></td>
                <td><Link to={`/community/post/${post.boardID}`}>{post.createAt}</Link></td>
              </tr>
            ))
          ) : (
            <tr>
